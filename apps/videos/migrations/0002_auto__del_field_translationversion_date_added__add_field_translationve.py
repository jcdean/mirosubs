...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'TranslationVersion.date_added'
        db.delete_column('videos_translationversion', 'date_added')

        # Adding field 'TranslationVersion.datetime_started'
        db.add_column('videos_translationversion', 'datetime_started', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.date(2010, 4, 13), blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'TranslationVersion.date_added'
        db.add_column('videos_translationversion', 'date_added', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.date(2010, 4, 13), blank=True), keep_default=False)
    ...
    models = {
        ...
        'videos.translationversion': {
            ...
            'datetime_started': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_complete': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
